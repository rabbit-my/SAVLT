...
def build_default_options():
    ...
    # model
    parser.add_argument('--model_name', default='biomedclip-b-16', type=str, help='Backbone model for CLIP')
    ...
    parser.add_argument('--text_lora_config', type=str, default='{"r":8, "lora_alpha":4, "gradual_step":12}')
    ...
    """/home/codebase/Yinmi/vlm_oct/segmentation/few_data_seg_unet/unet_best_fraction1_rep1.pth"""
